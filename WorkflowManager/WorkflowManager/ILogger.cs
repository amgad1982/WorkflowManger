...
namespace WorkflowManager
{
    ...
    {
        void Log(string message, LoggerInfoTypes infoType);
    }
    public enum LoggerInfoTypes
    {
        Information,
        Error,
        Warning
    ...
    public class ConsoleLogger : ILogger
    {
        public void Log(string message, LoggerInfoTypes infoType)
        {
            switch (infoType)
            {
                case LoggerInfoTypes.Error:
                    Console.WriteLine("Error:" + message);
                    break;
                case LoggerInfoTypes.Information:
                    Console.WriteLine("Info:" + message);
                    break;
                case LoggerInfoTypes.Warning:
    ...
    public class LoggerTrackingParticipant : TrackingParticipant
    {
        ...
        public LoggerTrackingParticipant(ILogger logger)
        {
            this.logger = logger;
        }
        ...
        protected override void Track(TrackingRecord record, TimeSpan timeout)
        {
            ...
            this.logger.Log(trackingContents.ToString(), LoggerInfoTypes.Information);
        }
