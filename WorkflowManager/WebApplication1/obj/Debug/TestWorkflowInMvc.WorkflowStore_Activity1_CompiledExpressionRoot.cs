    ...
    public partial class Activity1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 3)) {
                ...
                Activity1_TypedDataContext2 refDataContext3 = ((Activity1_TypedDataContext2)(cachedCompiledDataContext[1]));
            ...
            if ((expressionId == 4)) {
                ...
                Activity1_TypedDataContext2 refDataContext4 = ((Activity1_TypedDataContext2)(cachedCompiledDataContext[1]));
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 3)) {
                Activity1_TypedDataContext2 refDataContext3 = new Activity1_TypedDataContext2(locations, true);
                return refDataContext3.GetLocation<string>(refDataContext3.ValueType___Expr3Get, refDataContext3.ValueType___Expr3Set);
            }
            if ((expressionId == 4)) {
                Activity1_TypedDataContext2 refDataContext4 = new Activity1_TypedDataContext2(locations, true);
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            ...
            if (((isReference == false) 
                        && ((expressionText == "ErrorCounter+1") 
                        && (Activity1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 1;
                return true;
            }
            if (((isReference == true) 
                        && ((expressionText == "ErrorCounter") 
        ...
        public System.Linq.Expressions.Expression GetExpressionTreeForExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences) {
            ...
            if ((expressionId == 3)) {
                return new Activity1_TypedDataContext2(locationReferences).@__Expr3GetTree();
            }
            if ((expressionId == 4)) {
                return new Activity1_TypedDataContext2(locationReferences).@__Expr4GetTree();
            }
            return null;
        }
        ...
        private class Activity1_TypedDataContext2 : Activity1_TypedDataContext1 {
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 76 "C:\PROJECTS\WORKFLOWMANGER\WORKFLOWMANAGER\WEBAPPLICATION1\WORKFLOWSTORE\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                  Result;
            ...
            protected override void GetValueTypeValues() {
                this.ErrorCounter = ((int)(this.GetVariableValue((3 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((3 + locationsOffset), this.ErrorCounter);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 3)].Name != "ErrorCounter") 
        ...
        private class Activity1_TypedDataContext2_ForReadOnly : Activity1_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 69 "C:\PROJECTS\WORKFLOWMANGER\WORKFLOWMANAGER\WEBAPPLICATION1\WORKFLOWSTORE\ACTIVITY1.XAML"
